...
import { CalendarCheck, ShieldAlert, ArrowLeft } from 'lucide-react';
...
const Attendance = () => {
  ...
  // Derive dashboard back route based on role
  const getBackRoute = () => {
    ...
    <div className="p-8 sm:p-12 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl border border-[var(--color-border-light)] shadow-sm p-8">
           <h3 className="text-[#1a1b4b] font-black text-lg tracking-tight uppercase mb-6 flex items-center gap-3">
             <span>Module Logs</span>
             <span className="px-3 py-1 bg-gray-100 rounded-full text-[10px] text-gray-400 tracking-widest">{subjectData.length} active</span>
           </h3>
