...
import { useAcademicCalendar } from '../../hooks/useAcademicProgression';
...
const Calendar = () => {
  ...
  const { events: academicEvents } = useAcademicCalendar();
  ...
  ], [personalEvents, publicEvents, assignmentDeadlines, meetings, academicEvents]);
                 ...
                 <div className="space-y-1">
                    {dayEvents.map(e => (
                      <div key={e.id} className={`${
                        ...
                        e.type === 'Academic' ? 'bg-blue-50/60 border-blue-500' :
                  ...
                  <div key={day.toString()} className="h-full relative group hover:bg-gray-50/10">
                    ...
                    {dayEvents.map(e => (
                      <div key={e.id} className={`absolute inset-x-1 p-2 border-l-3 rounded-lg shadow-sm ${
                        ...
                        e.type === 'Academic' ? 'top-10 bg-blue-50 border-blue-500' :
              ...
              <p className="text-[12px] font-black text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-2 border-b border-gray-100 pb-2">Agenda</p>
               {dayEvents.map(e => (
                  <div key={e.id} className={`p-4 rounded-2xl border ${
                   ...
                   e.type === 'Academic' ? 'bg-blue-50 border-blue-100 shadow-sm' :
                   'bg-white border-indigo-100 shadow-sm'
                    ...
                    {e.type === 'Academic' && <p className="text-[12px] font-bold text-blue-600 uppercase tracking-widest mb-1">University Event</p>}
