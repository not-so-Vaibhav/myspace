    ...
    <div className="p-8 sm:p-12 space-y-10 bg-[#fcfdfe] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">Class Teacher</p>
      ...
      <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl shadow-[#1a1b4b]/5 overflow-hidden p-6 sm:p-10">
        ...
        <div className="bg-[#1a1b4b] p-4 rounded-2xl flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-white/50 text-[9px] font-bold uppercase tracking-widest">Academic Year 2025-26 · Sem-IV</p>
                </div>
            </div>
        ...
        <div className="grid grid-cols-[80px_repeat(10,1fr)] gap-1.5 min-w-[1000px]">
          {/* Header Row */}
          <div className="bg-gray-50 rounded-xl p-2 flex items-center justify-center text-[9px] font-black text-gray-400 uppercase tracking-widest">DAYS</div>
          {headers.map((h, i) => (
            <div key={i} className={`rounded-xl p-2 text-center text-[8px] font-black uppercase tracking-widest ${h.type === 'break' ? 'bg-amber-50 text-amber-600' : 'bg-gray-50 text-gray-400'}`}>
              {h.time}
            </div>
          ))}
          ...
          <div className="bg-gradient-to-br from-fuchsia-500 to-purple-600 rounded-xl p-3 flex flex-col items-center justify-center text-center">
             <span className="text-[10px] font-black text-white uppercase leading-tight">MON</span>
             <span className="text-[7px] font-black text-white/50 uppercase leading-tight">(ONL)</span>
          </div>
          <TimetableItem className="bg-gray-50/50"><span className="text-[10px] font-black text-[#1a1b4b]">SCIL</span></TimetableItem>
          <TimetableItem className="bg-gray-50/50"><span className="text-[10px] font-black text-[#1a1b4b]">CN : SJ</span></TimetableItem>
          {/* Column 4 - Break Pillar */}
          <div className="row-span-6 bg-amber-50/50 rounded-xl flex items-center justify-center">
            <span className="text-[10px] font-black text-amber-600 uppercase tracking-[0.3em]" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>SHORT BREAK</span>
          </div>
          <TimetableItem className="bg-gray-50/50"><span className="text-[10px] font-black text-[#1a1b4b]">OS : ATH</span></TimetableItem>
          <TimetableItem className="bg-[#1a1b4b]/5 border border-[#1a1b4b]/10 border-dashed"><span className="text-[8px] font-black text-[#1a1b4b] opacity-40 uppercase">REMEDIAL LECTURE</span></TimetableItem>
          {/* Column 7 - Lunch Pillar */}
          <div className="row-span-6 bg-[#1a1b4b]/5 rounded-xl flex items-center justify-center">
            <span className="text-[10px] font-black text-[#1a1b4b] opacity-40 uppercase tracking-[0.4em]" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>LUNCH BREAK</span>
          </div>
          <TimetableItem colSpan={2} className="bg-blue-50/50 border border-blue-100"><span className="text-[10px] font-black text-blue-600 uppercase">OE : NISM/NPTEL</span></TimetableItem>
          {/* Column 10 - Break Pillar (Mon-Thu) */}
          <div className="row-span-4 bg-amber-50/50 rounded-xl flex items-center justify-center">
            <span className="text-[10px] font-black text-amber-600 uppercase tracking-[0.3em]" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>SHORT BREAK</span>
          </div>
          <TimetableItem className="bg-gray-50/50"><span className="text-[10px] font-black text-[#1a1b4b]">MOOC</span></TimetableItem>

          {/* Tuesday Row */}
          <div className="bg-gray-50 rounded-xl p-2 flex items-center justify-center text-[10px] font-black text-[#1a1b4b] uppercase">TUE</div>
          ...
          <TimetableItem colSpan={2} className="bg-gray-50/50">
            <span className="text-[10px] font-black text-[#1a1b4b]">ENT : MAN</span>
            <span className="text-[8px] font-bold text-gray-400">N505</span>
          </TimetableItem>
          ...
          <TimetableItem className="bg-[#1a1b4b]/5 border border-[#1a1b4b]/10 border-dashed"><span className="text-[8px] font-black text-[#1a1b4b] opacity-40 uppercase">REMEDIAL</span></TimetableItem>
          <TimetableItem className="bg-[#1a1b4b]/5 border border-[#1a1b4b]/10 border-dashed"><span className="text-[8px] font-black text-[#1a1b4b] opacity-40 uppercase">REMEDIAL LECTURE</span></TimetableItem>

          {/* Wednesday Row */}
          <div className="bg-gray-50 rounded-xl p-2 flex items-center justify-center text-[10px] font-black text-[#1a1b4b] uppercase">WED</div>
          <TimetableItem className="bg-gray-50/50">
            <span className="text-[10px] font-black text-[#1a1b4b]">OS : ATH</span>
            <span className="text-[8px] font-bold text-gray-400">N505</span>
          </TimetableItem>
          <TimetableItem className="bg-gray-50/50">
            <span className="text-[10px] font-black text-[#1a1b4b]">EE : KS</span>
            <span className="text-[8px] font-bold text-gray-400">N505</span>
          </TimetableItem>
          <TimetableItem colSpan={2} className="bg-amber-100/50 border border-amber-200">
             <div className="text-[7px] font-black text-amber-700 leading-tight space-y-0.5">
          ...
          <TimetableItem className="bg-gray-50/50">
            <span className="text-[10px] font-black text-[#1a1b4b]">CN : SJ</span>
            <span className="text-[8px] font-bold text-gray-400">N505</span>
          </TimetableItem>
          <TimetableItem className="bg-emerald-500 shadow-lg shadow-emerald-500/20">
            <span className="text-[10px] font-black text-white">SCIL</span>
            <span className="text-[8px] font-bold text-white/50">N505</span>
          </TimetableItem>
          <TimetableItem className="bg-gray-50/50 opacity-40"><span className="text-[8px] font-black text-[#1a1b4b] uppercase">LIBRARY</span></TimetableItem>

          {/* Thursday Row */}
          <div className="bg-gray-50 rounded-xl p-2 flex items-center justify-center text-[10px] font-black text-[#1a1b4b] uppercase">THU</div>
          <TimetableItem className="bg-gray-50/50">
            <span className="text-[10px] font-black text-[#1a1b4b]">EE : KS</span>
            <span className="text-[8px] font-bold text-gray-400">N505</span>
          </TimetableItem>
          ...
          <TimetableItem className="bg-gray-50/50 opacity-40"><span className="text-[8px] font-black text-[#1a1b4b] uppercase">MENTOR MEETING</span></TimetableItem>

          {/* Friday Row */}
          <div className="bg-gray-50 rounded-xl p-2 flex items-center justify-center text-[10px] font-black text-[#1a1b4b] uppercase">FRI</div>
          <TimetableItem colSpan={2} className="bg-gray-50/50">
             <div className="text-[7px] font-bold text-gray-400 uppercase leading-none text-center">
                FAI1:N507 | TOC1:N505<br/>FCC1:N506 | CSE1:N510
             </div>
          ...
          <TimetableItem colSpan={3} className="bg-emerald-500 shadow-lg shadow-emerald-500/20">
             <div className="flex flex-col items-center">
                <span className="text-[9px] font-black text-white uppercase leading-tight text-center">SHD (SISM2) · 2:35 PM to 4:30 PM</span>
          ...
          <div className="bg-[#1a1b4b] rounded-xl p-2 flex flex-col items-center justify-center text-center">
             <span className="text-[10px] font-black text-white uppercase leading-tight">SAT</span>
          ...
          <TimetableItem colSpan={2} className="bg-gray-50/50 border border-gray-100">
            <span className="text-[10px] font-black text-[#1a1b4b]">OS : ATH</span>
            <span className="text-[8px] font-bold text-gray-400 uppercase">Room N505</span>
          </TimetableItem>
          <TimetableItem colSpan={2} className="bg-gray-50/50 border border-gray-100">
            <span className="text-[10px] font-black text-[#1a1b4b]">EE : KS</span>
            <span className="text-[8px] font-bold text-gray-400 uppercase">Room S605</span>
          </TimetableItem>
          <TimetableItem colSpan={4} className="bg-indigo-50 border border-indigo-100 shadow-sm">
             <span className="text-[11px] font-black text-indigo-600 uppercase tracking-[0.4em]">PBL II REVIEW SESSION</span>
             <span className="text-[8px] font-bold text-indigo-400 uppercase mt-1">01.40 PM to 04.30 PM</span>
          </TimetableItem>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Labs / Practical</span>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-amber-400"></div>
                    <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Batch Sessions</span>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-purple-500"></div>
                    <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Online / Hybrid</span>
                </div>
            </div>
        </div>
      </div>
